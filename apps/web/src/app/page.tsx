...
const pageStyles = {
  ...
  "failure-donut":
    'relative grid rounded-full place-items-center w-20.5 h-20.5 bg-border [&::after]:absolute [&::after]:rounded-full [&::after]:bg-card [&::after]:[content:""] [&::after]:[inset:8px] [&_>_span]:z-1 [&_>_span]:flex [&_>_span]:flex-col [&_>_span]:items-center [&_strong]:text-2xl [&_strong]:tracking-normal [&_small]:text-muted-foreground [&_small]:text-xs',
