...
CREATE UNIQUE INDEX projects_one_default_uq ON projects (is_default) WHERE is_default = 1;
...
CREATE UNIQUE INDEX ldap_group_mappings_scope_group_role_uq
  ON ldap_group_mappings (normalized_group_dn, role_id, COALESCE(project_id, ''));
