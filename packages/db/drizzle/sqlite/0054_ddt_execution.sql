ALTER TABLE ddt_cases ADD COLUMN execution_case_definition_id TEXT
  REFERENCES case_definitions(id) ON DELETE SET NULL;

ALTER TABLE ddt_deleted_cases ADD COLUMN execution_case_definition_id TEXT
  REFERENCES case_definitions(id) ON DELETE SET NULL;
...
ALTER TABLE execution_runs ADD COLUMN case_type TEXT NOT NULL DEFAULT 'testng'
  CHECK (case_type IN ('testng', 'ddt'));
ALTER TABLE execution_runs ADD COLUMN execution_case_definition_id TEXT;
ALTER TABLE execution_runs ADD COLUMN class_data_json TEXT;
ALTER TABLE execution_runs ADD COLUMN class_data_size_bytes INTEGER;
ALTER TABLE execution_runs ADD COLUMN class_data_sha256 TEXT;
ALTER TABLE execution_runs ADD COLUMN ddt_sr_num TEXT;
