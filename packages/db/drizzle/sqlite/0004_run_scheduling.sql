ALTER TABLE runners ADD COLUMN cpu_utilization_percent REAL;
ALTER TABLE runners ADD COLUMN memory_utilization_percent REAL;
ALTER TABLE runners ADD COLUMN load_average_1m REAL;
ALTER TABLE runners ADD COLUMN logical_cpu_count INTEGER;
ALTER TABLE runners ADD COLUMN metrics_observed_at TEXT;
...
CREATE TABLE run_attempts (
  ...
  scheduling_score REAL NOT NULL,
  created_at TEXT NOT NULL
);
